...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun  8 12:50:56 2017
...
for day in range(1,32): #Day range for an entire month
        filename = '/nfs/see-fs-01_users/gy11s2s/Python/NDACC_files/MLO/Plotting_months/August/' + str(day) + '.08.1991.txt' # Specifies July
