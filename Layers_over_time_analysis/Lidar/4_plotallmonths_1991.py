...
# -*- coding: utf-8 -*-
"""
Created on Wed Jun 21 14:39:16 2017
...
# Plots the first lower layers
                ...
                #layer1_upper_index = above_average_indices[0][-1] if above_average_indices[0][-1] < 48
...
plot = plt.contourf(JulianDayList, lower_layer1_values, color='r',label='Bottom of 1st layer')
plot = plt.contourf(JulianDayList, upper_layer1_values, color='b',label='Top of 1st layer')
plt.ylim(15, 30)
plt.xlim(152,366)
#plt.axhspan
...
plt.title('Volcanically enhanced region shown by backscatter ratio (1991)')